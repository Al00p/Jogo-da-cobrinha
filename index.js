...
// Atividade: criar os elementos boardBackground, snakeColor, snakeBorder, foodColor
const unitSize = 25
...
function changeDirection(event) {
    ...
    // Atividade: buscar o nome das teclas em JavaScript aqui: https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/keyCode
    ...
    if (keyPressed === esquerda && !indoParaDireita) { // Atividade: Verificar se está indo para esquerda
        xVelocity = -unitSize;
        yVelocity = 0;
    } else if (keyPressed === cima && !descendo) { // Atividade: verificar se está indo para cima
        xVelocity = 0;
        yVelocity = -unitSize;
    } else if (keyPressed === direita && !indoParaEsquerda) { // Atividade: verificar se está indo para a direita
        xVelocity = unitSize;
        yVelocity = 0;
    } else if (keyPressed === baixo && !subindo) { // Atividade: verificar se está indo para baixo
        xVelocity = 0;
        yVelocity = unitSize;
    }
}
...
function checkGameOver(){
    ...
    //Atividade: verificar se a cobra está batendo nas bordas
    if(snake[0].x < 0){
        running = false
